...
<link rel="stylesheet" href="${pageContext.request.contextPath}/admin/admin_css/css/all.min.css"/>
<link rel="stylesheet" href="${pageContext.request.contextPath}/admin/admin_css/css/icheck-bootstrap.min.css"/>
<link rel="stylesheet" href="${pageContext.request.contextPath}/admin/admin_css/css/adminlte.min.css"/>
...
<body class="hold-transition login-page">
	...
	<script src="${pageContext.request.contextPath}/admin/admin_css/js/jquery.min.js"></script>
	<script src="${pageContext.request.contextPath}/admin/admin_css/js/bootstrap.bundle.min.js"></script>
	<script src="${pageContext.request.contextPath}/admin/admin_css/js/adminlte.min.js?v=3.2.0"></script>
</body>
</html>
